...
"[I_EFFECT:ADD_SYNDROME]",
    ...
    --SOME STANDARD UNDEAD PROPERTIES, BUT NOT ALL OF THEM
		...
		"[SYN_NO_HOSPITAL]",--new
        "[CE_ADD_TAG:BLOODSUCKER:NO_AGING:NOT_LIVING:NOEXERT:NOPAIN:NOBREATHE:NOSTUN:NONAUSEA:NO_DIZZINESS:NO_FEVERS:PARALYZEIMMUNE:NO_EAT:NO_DRINK:NO_SLEEP:NO_PHYS_ATT_GAIN:NO_PHYS_ATT_RUST:START:0:ABRUPT]",
		...
		"[CE_CHANGE_PERSONALITY:FACET:LOVE_PROPENSITY:-20:FACET:BASHFUL:20:FACET:PRIVACY:20:FACET:TRUST:-20:FACET:EMOTIONALLY_OBSESSIVE:-20:FACET:EMOTIONALLY_OBSESSIVE:-20:FACET:GREGARIOUSNESS:-20:START:0:ABRUPT]",-- new personality facets
