...
interactions.secrets.necromancer=function(idx,sph)
    ...
    [I_EFFECT:ADD_SYNDROME]
        ...
        [SYNDROME]
			...
			[CE_CHANGE_PERSONALITY:FACET:LOVE_PROPENSITY:-25:FACET:EMOTIONALLY_OBSESSIVE:-25:FACET:SWAYED_BY_EMOTIONS:-25:FACET:TOLERANT:25:START:0:ABRUPT]// new personality alterations, necromancers are less emotional and more tolerant
