...
interactions.secrets.death=function(idx,sph)
    ...
    [I_EFFECT:ADD_SYNDROME]
        ...
        [SYNDROME]
			...
			[CE_CHANGE_PERSONALITY:FACET:LOVE_PROPENSITY:-25:FACET:EMOTIONALLY_OBSESSIVE:-25:FACET:SWAYED_BY_EMOTIONS:-25:START:0:ABRUPT]// intelligent undead are less emotional than they were in life
			...
			[CE_CAN_DO_INTERACTION:START:0:ABRUPT]// new summon skeleton ability
...
function basic_lieutenant_mfork(name,name_plural,token)
    ...
    [I_EFFECT:RESURRECT]
        ...
        [CE_REMOVE_TAG:HAS_BLOOD:TRANCES:MISCHIEVOUS:START:0:ABRUPT]
		[CE_MATERIAL_FORCE_MULTIPLIER:MAT_MULT:NONE:NONE:1:2:ABRUPT]// undead creatures get a 50% resistance against damage
		[CE_CHANGE_PERSONALITY:FACET:LOVE_PROPENSITY:-33:FACET:EMOTIONALLY_OBSESSIVE:-33:FACET:SWAYED_BY_EMOTIONS:-33:START:0:ABRUPT]// raised intelligent undead are less emotional than they were in life
